...
function Auth({ onLogin }) {
  ...
  const [twoFactorCode, setTwoFactorCode] = useState(""); // Input for Login
  const [generated2FA, setGenerated2FA] = useState(null); // Output from Register
